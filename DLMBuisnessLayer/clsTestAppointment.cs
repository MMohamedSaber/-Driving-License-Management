...
namespace DVLBuisnesLayer
{
    public class clsTestAppointment
    {
        ...
        public static bool IsHaveActiveAppointment(int LocalDrivingLIcenseApplicationID, clsTestType.enTestType TestTypeID)
        {
            return clsTestAppointmentData.IsHaveActiveAppointment(LocalDrivingLIcenseApplicationID, (int) TestTypeID);
        }
        ...
        public static bool IsAppointmentLocked(int LocalDrivingLicenseApplicationID,int TestTypeID)
        {

            return clsTestAppointmentData.IsAppointmentLocked(LocalDrivingLicenseApplicationID, TestTypeID);
        }

        public static clsTestAppointment FindTestAppointmentByLocalDrivingLicenseID(int LocalDrivingLicenseApplicationID, clsTestType.enTestType TestTypeID)
        {
            ...
            // البحث عن موعد الاختبار
            bool isFound = clsTestAppointmentData.FindTestAppointmentByLocalDrivingLicenseID(
            ...
            // إذا تم العثور على الموعد، أرجع كائن clsTestAppointment جديدًا
            if (isFound)
            {
            ...
            {
                // إرجاع null إذا لم يتم العثور على موعد
                return null;
            }

            
        }
        public static bool IsAppointmentExist(int LocalDrivingLicenseID, int TestType)
        {
            return clsTestAppointmentData.IsAppointmentExist(LocalDrivingLicenseID, TestType);
