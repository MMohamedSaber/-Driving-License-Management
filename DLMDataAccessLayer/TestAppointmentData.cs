...
namespace DLMDataAccessLayer
{
    public class clsTestAppointmentData
    {
        ...
        public static bool IsHaveActiveAppointment(int LocalDrivingLicenseID, int TestTypeID)
        {
            bool isFound = false;
            SqlConnection connection = new SqlConnection(DataAccessSetting.ConnectionString);
        ...
        public static bool IsAppointmentLocked(int LocalDrivingLicenseID, int TestType)
        {

            bool isFound = false;
            SqlConnection connection = new SqlConnection(DataAccessSetting.ConnectionString);
            string query = @"SELECT  TestAppointments.TestTypeID
                             FROM TestAppointments
        ...
        public static bool FindTestAppointmentByLocalDrivingLicenseID(
               int LocalDrivingLicenseApplicationID, int TestTypeID,
              ref int TestAppointmentID, ref DateTime AppointmentDate,
              ref float PaidFees, ref int CreatedByUserID, ref bool IsLocked, ref int RetakeTestApplicationID)
        {
